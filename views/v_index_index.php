<div id="pitch" class="container">
	<h1><img class="logo" src="/images/logo.png" alt="Quip logo"/>Welcome to Quip!</h1>
	<hr/>
	<div class="row">
		<div class="col-md-8">
			<p>Quip is a microblog application that enables you to share your thoughts, one quick quip at a time. Follow your friends to see what's on their minds. We're the microblog for hipsters, because Twitter is just too mainstream.</p>
